...
merged  production data from Combined pest and pollinator agricultural data (Dainese), climate (WorldClim), and soil (World Harmonized Soil Dataset) data
...
```{r}
# Import New transformed production dataset by crop type 
Merg_PROD<- read_csv("Merg_PRODNzc.csv")
